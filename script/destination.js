...
function createCard(item) {
  ...
  viewDetailsBtn.innerText = "View More Details";
  ...
  AddToCart.innerText = "Add To Trip";
  ...
  AddToCart.addEventListener("click", function () {
    ...
    if (userId) {
        ...
        .then((data) => {
          ...
          if (userObj.cart) {
            ...
            if (flag) {
              ...
              displayMessage("Already In Trip", "warning");
            } else {
      ...
      //login first
      displayMessage("Can't access Your Trip, Login First", "warning");
      setTimeout(() => {
